export class SwitchActionMapping {
  ...
  public merge(other: SwitchActionMapping) : SwitchActionMapping {
    ...
    if (this.serviceLabelIndex === undefined) {
      ...
      if (other.serviceLabelIndex !== undefined && this.serviceLabelIndex !== other.serviceLabelIndex) {
        throw new Error('Can NOT merge SwitchActionMapping instances with different service label indices. ' +
        `(got ${this.serviceLabelIndex} and ${other.serviceLabelIndex})`);
      }
    }
    if (this.valueSinglePress === undefined) {
      this.valueSinglePress = other.valueSinglePress;
    } else {
      if (other.valueSinglePress !== undefined && this.valueSinglePress !== other.valueSinglePress) {
        throw new Error('Can NOT merge SwitchActionMapping instances that both have a value for single press. ' +
        `(got ${this.valueSinglePress} and ${other.valueSinglePress})`);
      }
    }
    if (this.valueDoublePress === undefined) {
      this.valueDoublePress = other.valueDoublePress;
    } else {
      if (other.valueDoublePress !== undefined && this.valueDoublePress !== other.valueDoublePress) {
        throw new Error('Can NOT merge SwitchActionMapping instances that both have a value for double press. ' +
        `(got ${this.valueDoublePress} and ${other.valueDoublePress})`);
      }
    }
    if (this.valueLongPress === undefined) {
      this.valueLongPress = other.valueLongPress;
    } else {
      if (other.valueLongPress !== undefined && this.valueLongPress !== other.valueLongPress) {
        throw new Error('Can NOT merge SwitchActionMapping instances that both have a value for long press. ' +
        `(got ${this.valueLongPress} and ${other.valueLongPress})`);
      }
    }
    return this;
  }
