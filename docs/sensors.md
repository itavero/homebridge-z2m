...
| `soil_moisture`   | published       | [Humidity Sensor](https://developers.homebridge.io/#/service/HumiditySensor)              | [Current Relative Humidity](https://developers.homebridge.io/#/characteristic/CurrentRelativeHumidity)    | Uses the `soil` subtype to distinguish from regular humidity sensors.                        |
| `dry`             | published       | [Contact Sensor](https://developers.homebridge.io/#/service/ContactSensor)                | [Contact Sensor State](https://developers.homebridge.io/#/characteristic/ContactSensorState)              | Uses the `dry` subtype to distinguish from regular contact sensors.                          |
| `soil_fertility`  | published       | [Light Sensor](https://developers.homebridge.io/#/service/LightSensor)                    | [Current Ambient Light Level](https://developers.homebridge.io/#/characteristic/CurrentAmbientLightLevel) | Uses the `soil_fertility` subtype. Mapped to Light Sensor as there is no native HomeKit service for soil fertility. Value is in µS/cm. |
| `water_warning`   | published       | [Contact Sensor](https://developers.homebridge.io/#/service/ContactSensor)                | [Contact Sensor State](https://developers.homebridge.io/#/characteristic/ContactSensorState)              | Uses the `water_warning` subtype. Enum (`none`/`alarm`) mapped to contact state.             |
| `soil_fertility_warning` | published | [Contact Sensor](https://developers.homebridge.io/#/service/ContactSensor)               | [Contact Sensor State](https://developers.homebridge.io/#/characteristic/ContactSensorState)              | Uses the `soil_fertility_warning` subtype. Enum (`none`/`alarm`) mapped to contact state.    |
| `rain`            | published       | [Contact Sensor](https://developers.homebridge.io/#/service/ContactSensor)                | [Contact Sensor State](https://developers.homebridge.io/#/characteristic/ContactSensorState)              | Uses the `rain` subtype to distinguish from regular contact sensors.                         |
| `rain_intensity`  | published       | [Light Sensor](https://developers.homebridge.io/#/service/LightSensor)                    | [Current Ambient Light Level](https://developers.homebridge.io/#/characteristic/CurrentAmbientLightLevel) | Uses the `rain_intensity` subtype to distinguish from regular light sensors.                  |
| `illuminance_raw` | published       | [Light Sensor](https://developers.homebridge.io/#/service/LightSensor)                    | [Current Ambient Light Level](https://developers.homebridge.io/#/characteristic/CurrentAmbientLightLevel) | Uses the `illuminance_raw` subtype to distinguish from regular light sensors.                 |
| `illuminance_average_20min` | published | [Light Sensor](https://developers.homebridge.io/#/service/LightSensor)                 | [Current Ambient Light Level](https://developers.homebridge.io/#/characteristic/CurrentAmbientLightLevel) | Uses the `illuminance_avg` subtype to distinguish from regular light sensors.                 |
| `illuminance_maximum_today` | published | [Light Sensor](https://developers.homebridge.io/#/service/LightSensor)                 | [Current Ambient Light Level](https://developers.homebridge.io/#/characteristic/CurrentAmbientLightLevel) | Uses the `illuminance_max` subtype to distinguish from regular light sensors.                 |
| `cleaning_reminder` | published     | [Contact Sensor](https://developers.homebridge.io/#/service/ContactSensor)                | [Contact Sensor State](https://developers.homebridge.io/#/characteristic/ContactSensorState)              | Uses the `cleaning` subtype to distinguish from regular contact sensors.                      |
