...
export class IlluminanceRawSensorHandler extends BasicSensorHandler {
  ...
  constructor(expose: ExposesEntryWithProperty, allExposes: ExposesEntryWithBinaryProperty[], accessory: BasicAccessory) {
    super(
      ...
      expose,
      allExposes,
      IlluminanceRawSensorHandler.generateIdentifier,
      (n, t) => new hap.Service.LightSensor(n, t),
      'illuminance_raw'
    );
    accessory.log.debug(`Configuring IlluminanceRawSensor for ${this.serviceName}`);
