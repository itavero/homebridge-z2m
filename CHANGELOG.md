...
- Add support for `rain` (as Contact Sensor), `rain_intensity`, `illuminance_raw`, `illuminance_average_20min`, `illuminance_maximum_today` (as Light Sensors), and `cleaning_reminder` (as Contact Sensor) exposes for the Tuya RB-SRAIN01 rain sensor.
